...
from app.riskassessment.models.dynamodb_base import DynamoDBModel
from app.riskassessment.config import DYNAMODB_MESSAGE_TABLE
...
class MessageQueryBuilder:
    ...
    async def to_list(self) -> List["MessageDynamoDB"]:
        ...
        from app.riskassessment.databases.dynamodb_message_ops import DynamoDBMessageOperations
...
class MessageDynamoDB(DynamoDBModel):
    ...
    async def create_table_if_not_exists(cls):
        ...
        from app.riskassessment.config import AWS_REGION, AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY, AWS_SESSION_TOKEN
