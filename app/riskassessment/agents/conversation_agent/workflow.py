...
from app.riskassessment.agents.conversation_agent.nodes.chat_knowledgebase_node import (
    chat_knowledgebase_node,
)
from app.riskassessment.agents.conversation_agent.nodes.chat_node import chat_node
from app.riskassessment.agents.conversation_agent.nodes.text_summary_node import text_summary_node
from app.riskassessment.agents.conversation_agent.state import ConversationState
from app.riskassessment.agents.workflow import BaseWorkflow
    ...
    return {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "description": "General knowledge base integration for Q&A",
                "type": "processing",
